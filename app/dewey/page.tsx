...
export const metadata: Metadata = {
  title: "Courses - NEU ISE",
  description: "The NEU ISE course sequence from Bear Brown & Company. Each course develops a specific tier of human intelligence that AI cannot replicate.",
};
