...
> **NEU ISE: What AI Can and Can't Do** — a 5-course graduate series in Bear Brown & Company. Each course develops a specific tier of human intelligence that AI cannot replicate.

## Who this site is for
NEU ISE is the companion site for a graduate certificate program at Bear Brown & Company. It serves as the public-facing hub for course descriptions, research blog posts, interactive tools, and developer documentation.
...
## Author
**Nik Bear Brown**, Bear Brown & Company. Creator of the NEU ISE curriculum and this platform.
...
15. `/privacy` — Privacy Policy for NEU ISE
16. `/privacy/cookies` — Cookie Policy for NEU ISE (dedicated page)
17. `/terms-of-service` — Terms of Service for NEU ISE
...
- Logo: text-based "NEU ISE" in bold tracking-tighter
...
- **Program Info:** NEU ISE, Bear Brown & Company, Bear Brown & Company, bear@bearbrown.co
...
1. **Hero** (two-column): Left — h1 "NEU ISE", subtext "What AI Can and Can't Do", program description, "Explore Courses" + "Contact Us" buttons. Right — introductory video embed.
...
- Program introduction (NEU ISE at Bear Brown & Company)
...
## Legal Pages — DONE
All three pages use the same structural template, branded for NEU ISE. Bear Brown & Company, Bear Brown & Company. Contact: bear@bearbrown.co. Educational program.
...
irreduciblyhuman.xyz is the companion site for "NEU ISE: What AI Can and Can't Do," a 5-course graduate certificate in Bear Brown & Company. It runs on Next.js with Vercel auto-deploy. The public site has no login; the admin dashboard is cookie-protected.
...
**Courses** (`/courses`) — Card grid of the five courses in the NEU ISE sequence. Click a course to read its full description.
...
1. Rebrand Header, Footer, Home page, and About page to NEU ISE
2. Build `/courses` directory page and five individual course pages
3. Update legal pages (Privacy, Cookies, Terms) for NEU ISE branding
4. Update color palette for NEU ISE branding
